CLASS zcl_soa_el_data_csv_down DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_SOA_EL_DATA_CSV_DOWN IMPLEMENTATION.
...
*        delete fROM  ztest_el.
    ...
    ENDIF.
    DELETE FROM zsoa_elt_0005 WHERE   bukrs   EQ @gs_key-bukrs
      AND gjahr    EQ @gs_key-gjahr
       AND monat EQ @gs_key-monat .
        ...
        IF gr_log IS INITIAL.
          gr_log = cl_bali_log=>create_with_header(
              header = cl_bali_header_setter=>create(
                  object = 'ZSOALO_DATA_CSV'
                  subobject = 'ZLO_DATA_CSV_IN' ) ).
        ENDIF.
